...
class TaskDescriptionViewImpl(val project: Project) : TaskDescriptionView(), DataProvider, Disposable {
  ...
  override var currentTask: Task? = null
    set(value) {
      ...
      topPanel.isVisible = value != null && StudyTaskManager.getInstance(project).course is HyperskillCourse
      if (value != null) {
        readyToCheck()
  ...
  override fun init() {
    ...
    if (course != null && course is HyperskillCourse) {
      topPanel = course.getTaskDescriptionTopPanel(project)
